      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p
              className={`text-sm leading-relaxed max-w-xs ${isDark ? "text-slate-400" : "text-slate-600"
                }`}
            >
              ...
              {[
                ...
                <li key={item}>
                  <button
                    ...
                    className={`text-sm transition-colors animated-underline ${isDark
        ...
        {/* Bottom */}
        <div
          className={`flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t ${isDark ? "border-white/10" : "border-slate-200"
            }`}
        >
          <p
          ...
          <button
            ...
            className={`flex items-center gap-2 text-sm px-4 py-2 rounded-xl transition-all duration-200 ${isDark
